...
creds = credentials(api='dc600e0acd16ee7152a5c0691312907e', secret='2adc5baf89d446c9460a5e6373bfff87',
...
# test = CoinigyREST({'api': 'dc600e0acd16ee7152a5c0691312907e', 'secret': '2adc5baf89d446c9460a5e6373bfff87', 'endpoint':''})
open = CoinigyREST(creds)

results = open.data('BITS', 'BTC/USD', 'all')
